...
static PyTypeObject wrap_PyDictIter_Type;
...
MAKE_WRAPPERTYPE(PyDictIter_Type, dictiter, "dictionary-iterator",
		 dictiter_reduce, generic_new, generic_setstate)
...
static PyTypeObject wrap_PyGenerator_Type;
...
MAKE_WRAPPERTYPE(PyGenerator_Type, gen, "generator", gen_reduce,
